...
/*   Updated: 2025/02/08 02:14:34 by tamounir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../so_long_bonus.h"

static void	shapes2(t_game *game)
{
	game->enemy.img = mlx_xpm_file_to_image(game->mlx, "textures/enemy.xpm",
			&game->enemy.width, &game->enemy.height);
	game->right_wall.img = mlx_xpm_file_to_image(game->mlx,
			"textures/right_wall.xpm", &game->right_wall.width,
			&game->right_wall.height);
	game->left_wall.img = mlx_xpm_file_to_image(game->mlx,
			"textures/left_wall.xpm",
			&game->left_wall.width, &game->left_wall.height);
	if (!game->right_wall.img || !game->left_wall.img || !game->enemy.img)
	{
